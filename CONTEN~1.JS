...
window.CONTENIDO = {
  ...
  fundacion: {
    ...
    eslogan: "Iniciativa de la Fundación Miguel Alejandro para el Chocó",
  ...
  // --------------------------------------------------------------------
  titulo: "Información verificada sobre el terremoto · Chocó",
  descripcionCorta:
  ...
  descripcionLarga:
    "Aquí encontrarás información útil verificada de distintas fuentes y organizaciones públicas y privadas para recibir y dar apoyo tras el terremoto en Chocó: dónde pedir ayuda, dónde donar y a quién llamar. Solo debes dar clic en la sección que necesites.",
